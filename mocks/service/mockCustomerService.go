...
// Source: go-banking/service (interfaces: CustomerService)
...
func (m *MockCustomerService) GetAllCustomer(arg0 string) ([]dto.CustomerResponse, *resp_error.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockCustomerService) GetCustomer(arg0 string) (*dto.CustomerResponse, *resp_error.AppError) {
	m.ctrl.T.Helper()
